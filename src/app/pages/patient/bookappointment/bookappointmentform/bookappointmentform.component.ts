...
export class BookappointmentformComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private router: Router, private medicareService: MedicareService, private doctorService: DoctorService, private patientService: PatientService, private appointmentService: AppointmentService, private route: ActivatedRoute, private agentService: AgentsService, private loginService: LoginServiceService,private messageService: MessageService) { }
    ...
    this.bookAppointmentForm = this.formBuilder.group(
      {
        ...
        selectTimeSlot: new FormControl('', [
          Validators.required,
        ]),
      },
    );
