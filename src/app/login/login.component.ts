...
export class LoginComponent implements OnInit {
  ...
  loginForm: FormGroup;
  constructor(private formBuilder: FormBuilder, private router: Router, private loginService: LoginServiceService, private adminService: AdminService, private agentService: AgentsService, private doctorService: DoctorService, private patientService: PatientService) { }
      ...
      .subscribe((res) => {
        ...
        this.loginService.getUserId(this.loginForm.value.emailId).subscribe((userId: number) => {
          ...
          if (res.role === "ROLE_ADMIN") {
            ...
            this.adminService.getAdmin(+localStorage.getItem('userId')).subscribe((res: Admin) => {

              localStorage.setItem('username', res.firstName + " " + res.lastName)
              localStorage.setItem('gender', res.gender)
              this.loginService.loggedInUserName = res.firstName + " " + res.lastName; this.loginService.loggedInGender = res.gender;
              console.log(this.loginService.loggedInUserName + " " + this.loginService.loggedInGender);
            ...
            this.doctorService.getDoctor(+localStorage.getItem('userId')).subscribe((res: Doctor) => {
              ...
              if (res.approve == true) {
                ...
                alert("Your request is pending with admin. You can sign in once he approves.")
              }
            ...
            this.patientService.getPatient(+localStorage.getItem('userId')).subscribe((res: Patient) => {
