...
export class AddMedicareComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private router: Router, private medicareService: MedicareService, private loginservice: LoginServiceService) { }
  ...
  get f() { return this.addmedicareService.controls; }
